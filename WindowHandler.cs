...
/// <summary>
/// skidded from https://github.com/shalzuth/WindowSharingHider
/// </summary>
public static class WindowHandler
{
    ...
    public static Dictionary<IntPtr, String> GetVisibleWindows()
    {
        ...
        EnumWindows(delegate (IntPtr hWnd, IntPtr lParam)
        {
            ...
            /* this part is not skidded */
            GetWindowThreadProcessId(hWnd, out Int32 procId);
            var processName = Process.GetProcessById(procId).ProcessName;
            windows[hWnd] = processName;
            /* now it's skidded again */
